   ...
   this.state.fontLoaded ? (
    ...
    {`${this.convertSecondsToCalendarDate()}`}
      ...
      <View style={{alignItems: "center"}}>
       ...
       <Text style={{fontSize: 17, fontWeight: 'bold', color: 'white', paddingLeft: 20, paddingRight: 20, paddingTop: 10}}>Weather2Walk is an app designed by <Text style={{fontSize: 17, color: '#FF4500'}} onPress={()=>Linking.openURL('https://github.com/jah1603')}>James Henderson</Text><Text style={{fontSize: 17, color: '#FF4500'}} onPress={()=>Linking.openURL('https://github.com/SFR1981')}>, Stephen Rooney</Text> &<Text style={{fontSize: 18, color: '#FF4500'}} onPress={()=>Linking.openURL('https://github.com/DavidAPears')}> David Pears.</Text></Text>
        <Text style={{fontSize: 17, fontWeight: 'bold', color: 'white', padding: 20}}>James, Stephen and David built the app in an Edinburgh cafe using <Text style={{fontSize: 18, color: '#FF4500'}} onPress={()=>Linking.openURL('https://www.reactnative.com')}>ReactNative</Text>. Weather2Walk is part of their 'Weather2' series (see also 'Weather2Wed' and 'Weather2Golf').</Text>

       <Text style={{fontSize: 17, fontWeight: 'bold', color: 'white', paddingLeft: 20, paddingTop: 10, paddingRight: 20, paddingBottom: 10}}>Weather2Walk’s aim is to allow hikers and walking hobbyists to assess the weather for the area or range of hills they are planning to visit - at any location in Britain or Ireland. Powered by <Text style={{fontSize: 17, color: '#FF4500'}} onPress={()=>Linking.openURL('https://darksky.net/')}>Dark Sky</Text>, the app returns the typical weather (based on historical averages) for any given outdoor location in Britain and Ireland, as well as an approximate prediction of the moon phase powered by <Text style={{fontSize: 18, color: '#FF4500'}} onPress={()=>Linking.openURL('https://github.com/mourner/suncalc')}>SunCalc</Text>. The app utilises <Text style={{fontSize: 18, color: '#FF4500'}} onPress={()=>Linking.openURL('https://www.geograph.org.uk/')}>Geograph's API</Text> which means that almost any part of Britain and Ireland can be entered as a search term (the fuzzy search can handle lakes, hills and mountains, trails and other geographical features). Weather2Walk also suggests hotels in and around a prospective hiking location using the <Text style={{fontSize: 18, color: '#FF4500'}} onPress={()=>Linking.openURL('https://developer.foursquare.com/places-api')}>FourSquare API</Text>. There is no commercial benefit to us, the creators; this information is provided as a free service. Disclaimer: Weather2Walk's weather content is only provided as general guidance. Your use of the data is at your sole risk.</Text>
